...
***********************************************************************/
uint32_t enque_sequential_number = 1;
uint32_t deque_sequential_number = 1;
/***********************************************************************
...
void set_enque_sequential_number(){
    ...
    if(enque_sequential_number==0){
        enque_sequential_number = 1;
    }else{
        enque_sequential_number = 0;
    }
...
void set_deque_sequential_number(){
    ...
    if(deque_sequential_number==0){
        deque_sequential_number = 1;
    }else{
        deque_sequential_number = 0;
    }
