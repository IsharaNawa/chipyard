#ifndef EMBEDDED_CROPPED_CAT_H
#define EMBEDDED_CROPPED_CAT_H
...
extern const unsigned char embedded_cropped_cat[];
extern const size_t embedded_cropped_cat_size;

#ifdef __cplusplus
}
#endif

#endif /* EMBEDDED_CROPPED_CAT_H */
