...
riscv64-unknown-elf-gcc -march=rv64imaf_zicsr_zifencei -mabi=lp64f -mcmodel=medany -O2 -msmall-data-limit=0 -I. -I./include -I./driver decoder.c jpg.c embedded_cat.c kprintf.c driver/uart.c -static -nostdlib -Wl,-Ttext=0x80000000 -o ishara/decoder.elf # floating point operation compatible
